...
export default function ContactForm() {
  ...
  const inputClasses = `w-full rounded-xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-900
    placeholder-gray-400 outline-none transition-all duration-200
    focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20
    dark:border-white/10 dark:bg-white/5 dark:text-white dark:placeholder-zinc-500
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-5">
          {/* Form */}
          <div
            className="lg:col-span-3 rounded-2xl border border-gray-200 bg-white/80 p-8 sm:p-10
              shadow-xl backdrop-blur-xl
              dark:border-white/10 dark:bg-white/5 dark:shadow-2xl dark:shadow-black/20"
          >
            {success ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-full bg-green-100 dark:bg-green-500/10">
                  <svg
                ...
                <p className="text-gray-600 dark:text-zinc-400 mb-6 max-w-sm">
                  Thanks for reaching out. We&apos;ll get back to you within 24
                  hours.
                </p>
                <button
                  onClick={() => setSuccess(false)}
                  className="rounded-xl border border-gray-300 px-6 py-2.5 text-sm font-medium
          ...
          <div className="lg:col-span-2 flex flex-col gap-8">
            <div
              className="rounded-2xl border border-gray-200 bg-white/80 p-8 backdrop-blur-xl
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-50 text-blue-600 dark:bg-blue-500/10 dark:text-blue-400">
                    <svg
                      className="h-5 w-5"
                      fill="none"
                      viewBox="0 0 24 24"
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-sm text-gray-600 dark:text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                    >
                      (555) 123-4567
                    </a>
                  </div>
