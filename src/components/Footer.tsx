      ...
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
            ...
            <div className="mt-6 flex gap-3">
              {["facebook", "instagram", "twitter", "youtube"].map((social) => (
                <a
                  ...
                  href="#"
                  aria-label={social}
                  className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-gray-400 transition-colors hover:bg-blue-600/20 hover:text-blue-400"
                >
        ...
        <div className="mt-12 flex flex-col items-center gap-3 border-t border-white/5 pt-8 text-center">
          ...
          <p className="text-xs text-gray-600">
            Powered by AI Estimator Technology
          </p>
        </div>
      </div>
    </footer>
